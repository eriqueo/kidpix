...
KiddoPaint.ToolDescriptions = {
  ...
  "Wacky Cam": "Take a photo with the camera, then draw on it or Mixer it!",
  ...
  // so these are looked up by the exact `name:` in js/submenus/*. Text adapted from the
  // Kid Pix 2 manual (docs/reference/kid-pix-2-users-guide.md).

  // Mixer (js/submenus/jumble.js)
  Invert: "Swaps black and white and inverts colors.",
  Raindrops: "Splashes drops across your picture.",
  Checkerboard: "Gives your picture a checkerboard look.",
  Wallpaper: "Tiles a piece of your picture like wallpaper.",
  "Venetian Blinds": "Slices your picture into shuffled stripes.",
  "The Outliner": "Outlines every line in your picture.",
  "Shadow Boxes": "Copies pieces into overlapping boxes.",
  "Zoom In": "Drag to zoom in and magnify your picture.",
  "Broken Glass": "Shatters your picture into jagged pieces.",
  "Picture In A Picture": "Shrinks a copy to paste anywhere.",
  ...
  // Wacky Brush (js/submenus/brush.js)
  "Leaky Pen": "Ink soaks in whenever you stop moving.",
  "Zig Zag": "Bet you can't draw a straight line!",
  Dots: "Lots and lots of dots.",
  Bubbly: "Plenty of bubbles and fizz.",
  Pies: "Everyone wants a bigger slice of pie.",
  Echoes: "Circles within circles within circles.",
  "Northern Lights": "Colorful aurora — drag any direction.",
  Fuzzer: "Fuzzes up whatever it moves over.",
  "Magnifying Glass": "Enlarges whatever is under it.",
  "Spray Paint": "Sprays a line of mist.",
  "Pine Needles": "Paints a trail of pine needles.",
  "3-D": "Draws a line with a 3-D effect.",
  Kaliediscope: "Perfect symmetry wherever you paint.",
  "Drippy Paint": "Messy paint drips as you draw.",
  "Connect The Dots": "Numbered dots you can connect.",
  "Alphabet Line": "Paints with a line of letters.",
  "Rotating Dots": "Spinning rings of dots.",
  Inverter: "Flips the color of everything it touches.",
  Geometry: "Draws random geometric shapes.",
  "XY to XY": "Draws connecting lines point to point.",
  Tree: "Grows a fractal tree, each one different.",
  Caterpillars: "Symmetrical caterpillars crawl around.",
  "Splatter Paint": "The splattery paint-fight effect.",
  Starburst: "Bursts of starry lines.",
  "The Looper": "Loopy, tangled yarn.",
  "Roll The Dice": "Casts randomly numbered dice.",
  "A Galaxy of Stars": "Paint with a galaxy of stars.",
  "Lots of Hugs and Xs": "Paint with hugs and kisses (O's and X's).",
  "A Full Deck of Cards": "Paint with playing cards.",
  "Shapes and More Shapes": "Paint with all sorts of shapes.",
  "Paw Prints": "Paint a trail of paw prints.",

  // Eraser (js/submenus/eraser.js)
  "Eraser Squre 20": "Erase with a big square.",
  "Eraser Circle 15": "Erase with a round eraser.",
  "Eraser Square 10": "Erase with a medium square.",
...
function init_tool_bar() {
  ...
  if (colormeButton) {
    colormeButton.addEventListener("mousedown", function () {
      ...
      KiddoPaint.Display.canvas.classList = "";
      KiddoPaint.Display.canvas.classList.add("cursor-bucket");
      // No auto-load: a page is drawn onto the main canvas only when the user
      // picks one from the submenu, so activating ColorMe never overwrites the
      // drawing in progress. The page tiles (incl. the first one) are right
      // there in the submenu to choose from.
